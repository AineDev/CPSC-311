...
(define (do-once-promise-is-resolved promise-id k)
  (local ([define (computation-helper promise-id)
            (Î» (_ store stdout threads resolved-promises)
...
(define (resolve-promise-and-continue promise-id)
  ...
  (Î» (resolved-value store-rv stdout-rv threads-rv proms-rv)
  ...
  (local [ ;; next-promise-id : () -> Number
          ...
          (define (helper/k exp ; The original program
            ...
            (type-case D-PLE exp
              ...
              [fun (arg-name body)
                   (k (closureV (lambda (argv store-f stdout-f threads-f proms-f caller/k)
              ...
              [promise (expr)
                       (let* ([promise-id (next-promise-id)]
                              [promise-contents
                               ...
                               (Î» (_ current-store current-stdout current-threads current-proms)
              ...
              [after
               ...
               (helper/k
                ...
                (Î» (promise-v store-p stdout-p threads-p proms-p)
                  ...
                  (type-case D-PLE-value promise-v
                    [promiseV
                     ...
                     (helper/k
                      ...
                      (Î» (callback-v store-thn stdout-thn threads-thn proms-thn)
                          ...
                          [closureV
                           ...
                           (local ([define after-promise-id (next-promise-id)]
                                   [define after-behaviour
                                     ...
                                     (Î» (previous-value current-store current-stdout current-threads current-proms)
              ...
              [all (a b)
                   (helper/k
                    ...
                    (Î» (promise-a store-a stdout-a threads-a proms-a)
                      (type-case D-PLE-value promise-a
                        [promiseV
                         (promise-a-id)
                         (helper/k
                          b env store-a stdout-a threads-a proms-a
                          (Î» (promise-b store-b stdout-b threads-b proms-b)
